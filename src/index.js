import { form, serialize } from '../jsweb-packs/unpkg/params.js'
 ...
 * @returns {Promise} Promise
 */
export function task(input, ...args) {
 ...
 * @returns {Promise} Promise
 */
export async function request(url, cfg = {}) {
 ...
 * @returns {Promise} Promise
 */
export function requestAll(urls = [], cfg = {}, resp = 'response') {
 ...
 * @returns {Promise} Promise
 */
export function requestRace(urls = [], cfg = {}, resp = 'response') {
  const requests = urls.map((url) => map[resp](url, cfg))
 ...
 * @returns {Promise} Promise
 */
export async function requestJSON(url, cfg = {}) {
  try {
 ...
 * @returns {Promise} Promise
 */
export async function requestText(url, cfg = {}) {
  try {
    const resp = await request(url, cfg)
 ...
 * @returns {Promise} Promise
 */
export async function requestBlob(url, cfg = {}) {
  try {
    const resp = await request(url, cfg)
 ...
 * @returns {Promise} Promise
 */
export async function requestBoolean(url, cfg = {}) {
  try {
 ...
 * @returns {Promise} Promise
 */
export async function requestNumber(url, cfg = {}) {
  try {
 ...
 * @returns {Promise} Promise
 */
export async function requestXML(url, cfg = {}) {
  try {
 ...
 * @returns {Promise} Promise
 */
export async function requestHTML(url, cfg = {}) {
  try {
    const dom = new DOMParser()
    const text = await requestText(url, cfg)
